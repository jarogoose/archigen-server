...
public final class FacadeSummaryTemplate implements ArcTemplate {
  ...
  public static final String TEMPLATE = """
    ...
    public class {{feature-name}}SummaryFacade {
      ...
      private {{feature-name}}ReadService {{feature-name}}ReadService;

      private {{feature-name}}SummaryFacade({{feature-name}}ReadService {{feature-name}}WriteService) {
        this.{{feature-name}}ReadService = {{feature-name}}ReadService;
      }
