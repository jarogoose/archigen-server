...
public final class FacadeActionTemplate implements ArcTemplate {
  ...
  public static final String TEMPLATE = """
    ...
    public class {{feature-name}}ActionFacade {
      ...
      private {{feature-name}}WriteService {{feature-name}}WriteService;

      private {{feature-name}}ActionFacade({{feature-name}}WriteService {{feature-name}}WriteService) {
        this.{{feature-name}}WriteService = {{feature-name}}WriteService;
      }
